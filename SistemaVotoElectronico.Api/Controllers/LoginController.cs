    ...
    public class LoginController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResult<object>>> Login(LoginDto login)
        {
            try
            {
                ...
                if (admin != null)
                {
                    if (BCrypt.Net.BCrypt.Verify(login.Contrasena, admin.Contrasena))
                    {
                ...
                if (candidato != null)
                {
                    if (BCrypt.Net.BCrypt.Verify(login.Contrasena, candidato.Contrasena))
                    {
                        return ApiResult<object>.Ok(new
                        {
                ...
                if (votante != null)
                {
                    if (BCrypt.Net.BCrypt.Verify(login.Contrasena, votante.Contrasena))
                    {
                        return ApiResult<object>.Ok(new
                        {
